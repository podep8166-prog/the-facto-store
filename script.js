...
const products = [
    ...
    { id: 1, name: "أسمنت أسمر العسكري", price: 3900, img: "images/1772101763493.png", unit: "طن", type: "main", desc: "أقوى أنواع الأسمنت للخرسانة والأساسات الصعبة." },
    { id: 2, name: "أسمنت أبيض سوبر سيناء", price: 6600, img: "images/1772108604470.png", unit: "طن", type: "main", desc: "بياض ناصع وقوة تحمل للواجهات والديكورات." },
    { id: 3, name: "جبس نجمة سيناء", price: 3000, img: "images/1772102309114.png", unit: "طن", type: "main", desc: "جبس سريع التصلب وممتاز لأعمال المحارة." },
    { id: 4, name: "جبس المعمار", price: 2500, img: "images/1772103413723.png", unit: "طن", type: "main", desc: "جبس اقتصادي عالي الجودة لجميع الأغراض." },
    { id: 5, name: "جير مطفي طرة", price: 2250, img: "images/1772104038503.png", unit: "طن", type: "main", desc: "جير مطفي ممتاز لأعمال البناء التقليدية." },
    { id: 6, name: "حديد تسليح", price: 36000, img: "images/1772098405611.png", unit: "طن", type: "main", desc: "حديد تسليح مطابق للمواصفات الهندسية لجميع المنشآت." },
    { id: 7, name: "حديد سلاسل", price: 40000, img: "images/1772094259154.png", unit: "طن", type: "main", desc: "حديد سلاسل شديد المتانة للشدادات والمقاولات." },
    { id: 8, name: "طوب أبيض (أجري)", price: 2300, img: "images/1772096544841.png", unit: "1000 طوبة", type: "main", desc: "طوب خفيف الوزن وعازل ممتاز للحرارة والصوت." },
    { id: 9, name: "طوب أحمر", price: 1600, img: "images/1772096797178.png", unit: "1000 طوبة", type: "main", desc: "الطوب الأحمر الكلاسيكي للبناء المتين." },
    { id: 10, name: "زلط ثن", price: 400, img: "images/1772110754920.png", unit: "متر", type: "main", desc: "زلط نظيف للخلطات الخرسانية." },

    // 🛍️ قسم التجزئة
    { id: 11, name: "شكارة أسمنت أسمر", price: 195, img: "images/1772101763493.png", unit: "شكارة", type: "retail", desc: "شكارة أسمنت العسكري (تجزئة)." },
    { id: 12, name: "شكارة أسمنت أبيض", price: 265, img: "images/1772108604470.png", unit: "شكارة", type: "retail", desc: "شكارة أسمنت أبيض سيناء (تجزئة)." },
    { id: 13, name: "شكارة جبس نجمة", price: 90, img: "images/1772102309114.png", unit: "شكارة", type: "retail", desc: "شكارة جبس نجمة سيناء (تجزئة)." },
    { id: 14, name: "شكارة جبس معمار", price: 75, img: "images/1772103413723.png", unit: "شكارة", type: "retail", desc: "شكارة جبس المعمار (تجزئة)." },
    { id: 15, name: "شكارة جير", price: 45, img: "images/1772104038503.png", unit: "شكارة", type: "retail", desc: "شكارة جير طرة مطفي (تجزئة)." },
    { id: 16, name: "عتب (120سم)", price: 120, img: "images/1772113643987.png", unit: "قطعة", type: "retail", desc: "عتب خرساني جاهز ومتين للأبواب والشبابيك." }
];
